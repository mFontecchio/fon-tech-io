  ...
  protected readonly categories: NavCategory[] = [
    {
      ...
      items: [
        ...
        { label: 'Fieldset', path: '/components/form/fieldset' },
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Splitter', path: '/components/layout/splitter' },
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Image Compare', path: '/components/data-display/image-compare' },
