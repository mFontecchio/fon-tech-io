...
nx run-many -t build test lint</pre>
          ...
          <details>
            ...
            <pre>nx show project theme-builder-app</pre>
          </details>
    ...
    `
      ...
      *,
      ...
      .list-item-link {
        ...
        padding: 1rem;
        transition:
          background-color var(--semantic-animation-duration-interactive, 150ms)
            var(--semantic-animation-easing-default, cubic-bezier(0.4, 0, 0.2, 1)),
          color var(--semantic-animation-duration-interactive, 150ms)
            var(--semantic-animation-easing-default, cubic-bezier(0.4, 0, 0.2, 1));
        width: 100%;
      }
      ...
      .button-pill {
        padding: 1.5rem 2rem;
        margin-bottom: 2rem;
        transition: background-color var(--semantic-animation-duration-page, 350ms)
          var(--semantic-animation-easing-default, cubic-bezier(0.4, 0, 0.2, 1));
        align-items: center;
        display: flex;
      }
      ...
      summary {
        ...
        padding: 0.5rem;
        cursor: pointer;
        transition: background-color var(--semantic-animation-duration-interactive, 150ms)
          var(--semantic-animation-easing-default, cubic-bezier(0.4, 0, 0.2, 1));
      }
      summary:hover {
